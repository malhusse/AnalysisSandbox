...
factory.BookMethod(dataloader, R.TMVA.Types.kPyKeras, "DNN",
                   '!H:!V:VarTransform=D,G:FilenameModel=pyKerasModel_UI.h5:FilenameTrainedModel=trainedpyKerasModel_UI.h5:NumEpochs=100:BatchSize=1000:TriesEarlyStopping=3')
