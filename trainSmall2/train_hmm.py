...
sigCut = R.TCut("(h_mass > 115 && h_mass < 135) && mclabel < 0 && Entry$%2!=0")
bkgCut = R.TCut("(h_mass > 115 && h_mass < 135) && mclabel > 0")
...
factory.BookMethod(dataloader, R.TMVA.Types.kPyKeras, "DNN",
                   '!H:!V:VarTransform=G:FilenameModel=pyKerasModel_UI.h5:FilenameTrainedModel=trainedpyKerasModel_UI.h5:NumEpochs=100:BatchSize=1000:TriesEarlyStopping=5')
